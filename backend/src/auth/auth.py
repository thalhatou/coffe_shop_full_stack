...
AUTH0_DOMAIN = 'dev-kid.us.auth0.com'
# A list of algorithms that are allowed to be used with JSON Web Tokens.
ALGORITHMS = ['RS256']
...
'''
# source github : https://github.com/udacity/FSND/blob/master/BasicFlaskAuth/app.py
